...
class General(commands.Cog, name="general"):
    ...
    async def botinfo(self, context: Context) -> None:
        ...
        """
        embed = discord.Embed(
            description="Daily Task Bot, see https://github.com/Nana2929/discord-daily-task-bot for more information.",
            color=0x9C84EF)
        embed.set_author(name="Bot Information")
        embed.add_field(name="Owner:", value="pica#1911, Nana_29727#6581", inline=True)
    ...
    async def server(self, context: Context) -> None:
        ...
        embed = discord.Embed(
            description=
            f"Join the support server for the bot by clicking [here](https://discord.gg/mTBrXyWxAF).",
            color=0xD75BF4)
        try:
            await context.author.send(embed=embed)
            await context.send("I sent you a private message!")
    ...
    async def eight_ball(self, context: Context, *, question: str) -> None:
        ...
        embed = discord.Embed(title="**My Answer:**",
            ...
            async with session.get(
                ...
                if request.status == 200:
                    ...
                    embed = discord.Embed(
                        title="Bitcoin price",
                        description=
                        f"The current price is {data['bpi']['USD']['rate']} :dollar:",
                        color=0x9C84EF)
                else:
                    embed = discord.Embed(
                        title="Error!",
